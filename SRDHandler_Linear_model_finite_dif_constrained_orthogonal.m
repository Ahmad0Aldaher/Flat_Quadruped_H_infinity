classdef SRDHandler_Linear_model_finite_dif_constrained_orthogonal < SRDHandler
    properties
    ...
    methods
        ...
        function obj = SRDHandler_Linear_model_finite_dif_constrained_orthogonal(varargin)
            Parser = inputParser;
            Parser.FunctionName = 'SRDHandler_Linear_model_finite_dif_constrained_orthogonal';
        ...
        function Update(obj, ~)
            ...
            obj.c  = obj.N' * obj.get_acceleration(x, u);
            
            
            dz_array_N = zeros(obj.dof_z, obj.dof_z);
            for i = 1:obj.dof_z
                xi = x + obj.N * obj.finite_dif_step_z(:, i);
                dzi = obj.N' * obj.get_acceleration(xi, u);
            ...
            for j = 1:dof_ctrl
                ...
                dzj = obj.N' * obj.get_acceleration(x, uj);
                b_array(:, j) = dzj - obj.c;
            end
