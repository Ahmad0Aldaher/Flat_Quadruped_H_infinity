...
SymbolicEngine = SRDSymbolicEngine('LinkArray', LinkArray, 'Casadi', Casadi);
...
constraint = [SymbolicEngine.LinkArray(5).AbsoluteFollower(1); 
              SymbolicEngine.LinkArray(6).AbsoluteFollower(1); 
              SymbolicEngine.LinkArray(5).AbsoluteFollower(3); 
              SymbolicEngine.LinkArray(6).AbsoluteFollower(3)]; 
          

% constraint = [SymbolicEngine.LinkArray(5).AbsoluteFollower(1); 
%               SymbolicEngine.LinkArray(5).AbsoluteFollower(3); 
%               SymbolicEngine.LinkArray(2).AbsoluteFollower(1); 
%               SymbolicEngine.LinkArray(2).AbsoluteFollower(3)];           
%  
% constraint = [SymbolicEngine.q(3)];           
...
[description, A, B, iM] = SRD_generate_dynamics_linearization_c(...
    'SymbolicEngine',                         SymbolicEngine, ...
    'H', H, ...
    'c', c, ...
    'T', T, ...
...
Task = [SymbolicEngine.q(1:3); constraint]; 
%%%%%%%%%
